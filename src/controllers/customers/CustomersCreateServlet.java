...
public class CustomersCreateServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if(_token != null && _token.equals(request.getSession().getId())) {
            ...
            Date customer_date = new Date(System.currentTimeMillis());
            String cd_str = request.getParameter("customer_date");
            if(cd_str != null && !cd_str.equals("")) {
                customer_date = Date.valueOf(request.getParameter("customer_date"));
            }
            c.setCustomer_date(customer_date);
